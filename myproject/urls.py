...
# from accounts import views as acct_view
from django.conf import settings
from django.conf.urls.static import static

urlpatterns = [
    path('', views.home, name='home'),
    re_path('^profile/$', accounts_views.profile_view, name='profile'),
    re_path(r'^signup/$',accounts_views.signup,name='signup'),
     path('logout/', accounts_views.custom_logout_view, name='logout'),
